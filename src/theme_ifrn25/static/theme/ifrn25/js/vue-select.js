...
const u = Vue.createElementVNode;
const K = Vue.resolveDirective;
const A = Vue.normalizeClass;
const r = Vue.renderSlot;
const d = Vue.normalizeProps;
const c = Vue.guardReactiveProps;
const B = Vue.Fragment;
const L = Vue.renderList;
const v = Vue.createTextVNode;
const D = Vue.toDisplayString;
const b = Vue.createBlock;
const _ = Vue.resolveDynamicComponent;
const O = Vue.createCommentVNode;
const k = Vue.mergeProps;
const j = Vue.toHandlers;
const w = Vue.withDirectives;
const P = Vue.vShow;
const $ = Vue.createVNode;
const R = Vue.Transition;
const z = Vue.withCtx;
const F = Vue.withModifiers;
const U = {
  props: {
    autoscroll: {
      type: Boolean,
...
https://vue-select.org/api/props.html#getoptionkey`, e, t);
  ...
  computed: {
    ...
    searchPlaceholder() {
      if (this.open) return undefined // Remove placeholder quando dropdown está aberto
...
}, Oe = /* @__PURE__ */ v(" Nenhuma opção correspondente. "), we = ["id"];
function ve(e, t, s, n, l, i) {
  ...
  return a(), h("div", {
    ...
    u("div", {
      ...
      "aria-label": "Pesquisar por opção",
        ...
        (a(!0), h(B, null, L(i.selectedValue, (o, p) => r(e.$slots, "selected-option-container", {
          ...
          (a(), h("span", {
            ...
            s.multiple ? (a(), h("button", {
              ...
              type: "button",
              class: "vs__deselect",
              title: `Remover ${s.getOptionLabel(o)}`,
              "aria-label": `Remover ${s.getOptionLabel(o)}`,
        ...
        i.dropdownOpen ? w((a(), h("ul", {
          ...
          i.filteredOptions.length === 0 ? (a(), h("li", _e, [
            r(e.$slots, "no-options", d(c(i.scope.noOptions)), () => [
              v(" Nenhuma opção correspondente. ")
            ])
          ])) : O("", !0),
